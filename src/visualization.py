        ...
        for i in range(len(detections)):
            ...
            if track_id in potential_passing or track_id in confirmed_passing:
                ...
                if track_id in confirmed_passing:
                    box_color = (0, 0, 255)  # Red for confirmed
                else:
                    box_color = (0, 255, 255)  # Yellow for potential

                # Core visualization elements only
                ...
                # Simplified label positioning - decide whether to put label on top or bottom
                # If too close to top, put it below the box else above it
